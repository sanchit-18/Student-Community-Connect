<?php
	...
	class NewUser {
	    ...
	    public function validate($fullname, $gender, $age, $org, $email, $username, $password, $usertype) {
			...
			if (is_int($age) === false) { array_push($errors, "Age must be an integer"); }
			...
			//if (user_exists($username)) { array_push($errors, "Username already exists");}
